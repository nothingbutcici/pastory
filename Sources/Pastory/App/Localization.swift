...
enum L {
    ...
    static let en: [String: String] = [
        ...
        "在「系统设置 › 隐私与安全性 › 屏幕录制」里打开 Pastory。已经打开了的话，权限要重新启动后才生效。":
            "Turn Pastory on in System Settings › Privacy & Security › Screen Recording. If it is already on, the permission only takes effect after a relaunch.",
        ...
        "没收到按键。如果对方应用弹出来了，说明这个组合已被它占用": "No key arrived. If another app popped up, that combination is already its.",
        ...
        "这不是 SQLite 数据库文件": "Not a SQLite database", "没有找到能导入的文本或图片": "No importable text or images found",
        // Cards
        ...
        "暂停同步至剪贴板": "Pause clipboard capture",
        "本地数据库截图存储方式": "How screenshots are stored locally", "高质量 HEIC（约小 3 倍）": "High-quality HEIC (about 3× smaller)", "无损 PNG": "Lossless PNG",
        ...
        "录屏编码": "Recording codec", "H.264（所有设备都能播放）": "H.264 (plays on every device)", "HEVC（体积小一半，老设备和部分 Windows 打不开）": "HEVC (half the size; older devices and some Windows PCs cannot open it)",
        ...
        "系统设置": "System Settings", "把保留期改成 %d 天？": "Change retention to %d days?",
        ...
        "扫描中…": "Scanning…", "找到 %d 条文本、%d 张图片": "Found %d texts and %d images",
