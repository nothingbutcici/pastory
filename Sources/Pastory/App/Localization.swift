...
enum L {
    ...
    static let pairs: [(String, String)] = [
        ...
        ("稍后也能在设置中调整", "You can adjust these in Settings later"), ("也可以从顶部菜单栏打开", "You can also open it from the menu bar"),
        ...
        ("按下组合键…", "Press keys…"), ("被其他应用占用，点击换一个", "Taken by another app. Click to pick another"),
