...
enum L {
    ...
    static let pairs: [(String, String)] = [
        ...
        ("欢迎使用 Pastory", "Welcome to Pastory"), ("设置常用快捷键", "Set your two shortcuts"), ("开始使用", "Get Started"),
        ("稍后也能在设置中调整哦", "You can adjust these in Settings later"), ("复制一段文本", "Copy some text"), ("将一个卡片 Pin 起来", "Pin a card"), ("点击「开始使用」，卡片消失", "Click Get Started and this card goes away"), ("立即设置", "Set Now"),
        ...
        ("把一张卡片向上拖出面板，贴到桌面上", "Drag a card up out of the shelf onto the desktop"), ("拖动边框调整录制范围", "Drag the frame to adjust the recording area"), ("开始录制 ⏎", "Start Recording ⏎"),
        ("联系我", "Contact"), ("反馈 bug & 提功能", "Bugs & feature requests"), ("Pastory 微信小小群，交个朋友", "A small WeChat group for Pastory. Come say hi."),
        ("GitHub 点个 Star 吧", "Star it on GitHub"), ("开源产品，喜欢就请助力一下", "Open source. If you like it, a Star helps."), ("关注我的 X", "Follow me on X"),
        ...
        ("跳过这个版本", "Skip This Version"), ("自动更新没有成功", "The update could not be installed"), ("录屏编码", "Recording codec"), ("所有设备都能播放", "Plays on every device"), ("体积小一半；老设备和部分 Windows 打不开", "Half the size; older devices and some Windows PCs cannot open it"),
