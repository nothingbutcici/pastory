...
enum L {
    ...
    static let en: [String: String] = [
        ...
        "版本 %@ · 每天自动检查更新": "Version %@ · check for updates daily", "检查更新": "Check for Updates", "检查更新…": "Check for Updates…",
        ...
        "位置": "Locations", "「保存到本地」默认打开的文件夹": "Default folder for “Save to Disk”", "默认": "Default", "选择…": "Choose…",
